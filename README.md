...
Forex Lab is a native Android forex-analysis app backed by a Python API on Google Cloud Run.
...
The app does not call the market-data provider directly. The Android client talks only to the Forex Lab backend.
...
- broader pair and timeframe access
...
This repository contains both the Android product surface and the production backend used for live charting, scanning, historical validation, alerts, presets, entitlement checks, and subscription-aware workflow gating.
